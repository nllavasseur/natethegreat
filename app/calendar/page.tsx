    ...
    const refreshRemote = async () => {
      ...
      try {
        const [draftsRes, blocksRes, tasksRes] = await Promise.all([
          // Fetch all drafts so older estimates can't be pushed out of an updated_at-sorted limited window.
          // iPad Safari can be slow to establish the request, so allow a longer timeout.
          withTimeout(fetchDrafts(), 12000),
