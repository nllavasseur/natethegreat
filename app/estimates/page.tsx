          ...
          <>
            {(!takeoffError && (generatedMaterials?.length || 0) === 0 && takeoffDiagnostics) || takeoffError || saveError || saveNotice ? (
              <div
                ...
                style={{ bottom: "calc(max(calc(env(safe-area-inset-bottom) - 24px), 0px) + 76px)" }}
            ...
            >
              <div className="mx-auto max-w-[980px]">
                <div className="bg-[rgba(20,30,24,.75)] border border-[var(--stroke)] shadow-glass rounded-2xl flex flex-col justify-end pb-[max(calc(env(safe-area-inset-bottom) - 24px),0px)]" style={{ WebkitBackdropFilter: "none", backdropFilter: "none" }}>
